...
var compiledRecord = require('../sourcerecord');
...
function compile(filePath, req, res, next){
  ...
  fs.stat(filePath, function(err, stat){
    ...
    rollup({
      ...
      compiledRecord.add(filePath, result.map.sources);
      log.debug("result::sourceMap====>" + JSON.stringify(compiledRecord.getSources(filePath)));
